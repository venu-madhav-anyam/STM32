...
volatile uint8_t debug_tx;
volatile uint8_t debug_rx;
...
int main(void) {
	...
	while (1)
	{
	    if (SPI1Handle.TxRxState == SPI_READY)
	    {
	        SPI_TransmitReceive_IT(&SPI1Handle, &tx_data, &rx_data, 1);
	    }
